            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start lg:ml-10">
                        ...
                        <motion.button
                            ...
                            initial="hidden"
                            animate="visible"
                            className=" mb-4 mr-2 rounded bg-neutral-900 px-6 py-3 text-lg font-medium text-yellow-200">
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        ...
                        className="w-7/8 rounded-2xl" src={profilePic} alt="Navnihal Satpute" />
                    </div>
                </div>
            </div>
        </div>
